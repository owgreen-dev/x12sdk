...
class HeaderStSegment(StSegment):
    ...
    transaction_set_identifier_code: Literal["277"]
...
class Loop2200BTrnSegment(TrnSegment):
    """
    Information Receiver Trace Segment
    """

    trace_type_code: Literal["2"]
    originating_company_identifier: Optional[str] = None


class Loop2200CTrnSegment(TrnSegment):
    """
    Service Provider Trace Segment
    """
...
class Loop2220DSvcSegment(SvcSegment):
    """
...
class Loop2220DRefSegment(RefSegment):
    """
...
class Loop2220DDtpSegment(DtpSegment):
    """
